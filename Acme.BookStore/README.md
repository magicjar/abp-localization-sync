...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4ae11899-be80-4a45-9354-ef86706bdc02
```

> `4ae11899-be80-4a45-9354-ef86706bdc02` is the password of the certificate, you can change it to any password you want.
